...
<head>
	...
	<title>JPA Bookshelf :: Spring Data JPA Repository Demo</title>
...
<div id="page" class="container">
	...
	<hr />
	<div id="footer">
		<a href="http://www.springsource.org/spring-data/jpa">
			<img src="<c:url value="/resources/images/powered-by-spring-data.png"/>" alt="Powered by Spring Data JPA" />
		</a>
	</div>
</div>
</body>
